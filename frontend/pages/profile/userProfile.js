 ...
 // フック
  ...
  const handleSubmit = (e) => {
    ...
    const formattedUserProfile = {
      ...
      annual_income: selectedAnnualIncomeId,
      purpose: selectedPurposeIds,
      hobbies: selectedHobbyIds,
      introduction: introduction,
      residence_prefecture: selectedResidencePrefectureId,
      residence_citys: selectedResidenceCityIds,
      workplace_prefecture: selectedWorkplacePrefectureId,
      workplace_citys: selectedWorkplaceCityIds,
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <DropdownSelect
          label="住所（都道府県）"
          options={prefecture}
          value={selectedResidencePrefectureId}
        ...
        {selectedResidencePrefectureId && (
          <CheckboxGroup
            ...
            selectedValues={selectedResidenceCityIds}
        ...
        <DropdownSelect
          label="職場・学校（都道府県）"
          options={prefecture}
          value={selectedWorkplacePrefectureId}
        ...
        {selectedWorkplacePrefectureId && (
          <CheckboxGroup
            ...
            selectedValues={selectedWorkplaceCityIds}
