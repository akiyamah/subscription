    ...
    return (
        <>
            ...
            <div className="border rounded w-1/3 mx-auto text-center shadow-sm">
                <div className="p-4">
                    <h2 className="text-2x1 font-medium mb-4">有料会員</h2>
                    <div className="Dtext-gray-509 mb-4">有効コンテンツをご利用頂けます。</div>
                    <div className="mb-4">
                        <span className="text-4x1 font-extrabold">3000円</span>
                        <span className="font-medium">/月</span>
                    </div> 
                    <div className="flex justify-center">
                        {loading ? (
                            <Oval color="#59E00" width={50} height={50} />
                        ) : (
                            <div className="button-yellow cursor-pointer" onClick={checkoutHandle}>決済</div>
                        )}
                    </div>
                </div> 
            </div>
