...
const handleUpdate = async (email, customer_id, created) => {
    ...
    const body = JSON.stringify({email, customer_id, created,})

    try {
        console.log('aip/webhooks/index.js ')
...
const webhookHandler = async (req, res) => {
    if (req.method === 'POST') {
        ...
        res.status(200).send('Webhook event received and processed successfully');
    } else {
